...
<div class="card-body">
  ...
  <form  action="" method="post" action="/addProduct" enctype="multipart/form-data">
  {{ csrf_field() }}
  ...
  <div class="form-group">
    ...
    <textarea name="productDesc" required class="form-control" id="productDesc" rows="3">{{$Product->description}}</textarea>
  </div>
